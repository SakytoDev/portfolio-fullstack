  ...
  return (
    <div className='p-2 border-2 rounded-xl flex flex-col gap-2'>
      ...
      <div className='grid grid-cols-2 gap-2'>
        ...
        <button className='border-2 p-1 border-blue-400 rounded-lg text-lg font-medium transition ease-in-out hover:bg-blue-600'>Open Chat</button>
      </div>
    </div>
  )
}
...
export default function ChatMenu() {
  ...
  async function getFriends() {
    ...
    if (result.code == 'success') {
      setPeopleList(Object.values(result.accounts.friends))
    }
  }
